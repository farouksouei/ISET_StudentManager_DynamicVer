        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="DeleteStudent.php"><i class="bi bi-person-dash"></i>Delete Student</a>
              </li>
              <li class="nav-item">
...
<body>
  <div class="container px-4 py-5" id="hanging-icons">
    <h2 class="pb-2 border-bottom">Supprimer un etudiant</h2>
    ...
    <table class="table table-hover list" id="studentList">
      ...
      ?>
        ...
        <td><?php echo $row['id'] ?></td>
          ...
          <td> <a href="AddNewStudent.php?edit=<?php echo $row['id'];?>" class="btn btn-info">Update</a> </td>
        </tr>
<?php endwhile;  ?>
    </table>
